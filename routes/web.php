...
Route::get('/clients/cadastrar', [ClientController::class, 'cadastrar'])->name('clients.cadastrar');
Route::get('/clients/{id}', [ClientController::class, 'show'])->name('clients.show');
Route::post('/clients',[ClientController::class, 'store'])->name('clients.store');

Route::get('/clients/{id}/editar', [ClientController::class, 'editar'])->name('clients.editar');
